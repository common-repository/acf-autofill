...
class ACFA_Autofiller {
	...
	public function enqueue_scripts() {
		wp_enqueue_script( 'acfa-data', ACFA_PLUGIN_BASE_DIR . '/public/js/data.js', array(), time(), false );
		wp_enqueue_script( 'acfa-helpers', ACFA_PLUGIN_BASE_DIR . '/public/js/helpers.js', array( 'acfa-data' ), time(), false );
		wp_enqueue_script( 'acfa-media-upload', ACFA_PLUGIN_BASE_DIR . '/public/js/mediaUpload.js', array( 'jquery' ), time(), false );
		wp_enqueue_script( 'acfa-field-handler', ACFA_PLUGIN_BASE_DIR . '/public/js/fieldHandler.js', array( 'acf', 'acfa-data' ), time(), false );
